  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block h-4 w-4 rounded-lg border-2 border-[#1b1b3a] bg-[#ffe45e] transition-transform duration-300 ease-out data-[state=checked]:translate-x-5.5 data-[state=unchecked]:translate-x-0.5"
        )}
      />
    </SwitchPrimitive.Root>
  )
