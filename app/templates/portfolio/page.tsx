    ...
    <div className="relative overflow-hidden min-h-screen pb-20" style={{ background: "var(--y2k-panel)" }}>
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-6 sm:py-10">
        ...
        <div className="rounded-lg border-[3px] border-y2k-ink bg-white overflow-hidden mb-8">
          {/* Title Bar */}
          <div className="flex items-center justify-between border-b-[3px] border-y2k-ink px-4 py-2.5" style={{ background: "var(--y2k-blue)" }}>
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-mono text-xs font-black text-y2k-ink uppercase tracking-wider">
                template-portfolio-showcase.exe
              </span>
            </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-8">
              <div className="max-w-2xl">
                <div className="flex items-center gap-2 flex-wrap mb-3">
                  ...
                  <span className="inline-flex items-center gap-1 rounded border-2 border-y2k-ink bg-y2k-pink px-1.5 py-px text-[9px] font-black text-y2k-ink">
                ...
                <p className="mt-3 text-sm text-y2k-ink/60 leading-relaxed max-w-lg">
                  A premium, responsive portfolio styled as a retro desktop operating system.
                  Complete with an interactive boot loader splash screen, draggable-like floating
                  window sections, and clean GSAP stagger reveal animations.
                </p>
              </div>
              ...
              <div className="flex flex-row lg:flex-col gap-2.5 shrink-0">
                <a
                  href="http://portfolio-template.y2k-ui.web.id"
                  target="_blank"
                ...
                <a
                  href="https://github.com/MuhamadZafarSyah/y2k-ui-portfolio-template"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full"
                >
            ...
            <div className="relative rounded border-[3px] border-y2k-ink bg-y2k-panel overflow-hidden aspect-video mb-10">
              <Image
                src="/assets/images/templates/portfolio.png"
                alt="Y2K Personal Portfolio Template Screenshot"
                fill
                priority
