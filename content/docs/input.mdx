---
title: Input
description: A Y2K text input component with thick navy outline. Supports leadingIcon, trailingIcon, prefix, and suffix add-ons. Accessible and customizable.
---
  ...
  data={[
    {
      prop: "leadingIcon",
      type: "ReactNode",
      description: "Icon rendered on the left inside a pastel add-on chip.",
    },
    {
      prop: "trailingIcon",
      type: "ReactNode",
      description: "Icon rendered on the right inside a pastel add-on chip.",
    },
    {
      prop: "prefix",
      type: "ReactNode",
      description:
        "Short label shown on the left of the value (e.g. 'Rp', '@', '$').",
    },
    {
      prop: "suffix",
      type: "ReactNode",
      description:
        "Short label shown on the right of the value (e.g. 'IDR', 'kg', 'USD').",
    },
    {
      prop: "wrapperClassName",
      type: "string",
      description:
        "Extra classes applied to the outer wrapper when add-ons are present.",
    },
    {
      prop: "type",
      type: "string",
