---
title: "Dropdown Menu"
description: "Y2K dropdown menu component built on Radix UI. Supports items, checkboxes, radio groups, sub-menus, and keyboard navigation."
---
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: "number",
      default: "6",
      description: "Distance between the trigger and the panel.",
    },
    {
      prop: "disabled",
      type: "boolean",
