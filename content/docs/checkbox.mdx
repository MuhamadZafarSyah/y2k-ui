---
title: "Checkbox"
description: "Y2K checkbox component built on Radix UI with thick navy border and lemon fill when checked. Accessible toggle control."
---
...
<CodeBlock
  ...
  code="npx y2kui@latest add checkbox"
/>
